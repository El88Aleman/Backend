...
export class TicketManagerDB {
  ...
  async purchaseCart(newTicket) {
    try {
      ...
      logger.error(
        `purchase cart error: Error al crear el ticket de compra: ${error}`
      );
      throw new Error(
        `purchase cart error: Error al crear el ticket de compra: ${error}`
      );
  ...
  async getTickets() {
    try {
      ...
      logger.error(
        `get tickets error: Error al obtener los tickets de compra: ${error}`
      );
      throw new Error(
        `get tickets error: Error al obtener los tickets de compra: ${error}`
      );
  ...
  async getTicketById(ticketId) {
    try {
      ...
      logger.error(
        `get ticket by id error: Error al obtener el ticket de compra: ${error}`
      );
      throw new Error(
        `get ticket by id error: Error al obtener el ticket de compra: ${error}`
      );
