...
router.post("/:cid/product/:pid", async (req, res) => {
  try {
    ...
    const addedProductToCart = await cartManagerService.addProductToCart(
      cid,
      pid
    );
...
router.put("/:cid", async (req, res) => {
  try {
    ...
    const updatedProductsInCart = await cartManagerService.updateProductsInCart(
      cid,
      newProducts
    );
...
router.put("/:cid/products/:pid", async (req, res) => {
  try {
    ...
    const updatedQuantityProductInCart =
      await cartManagerService.updateProductQuantityInCart(
        cid,
        pid,
        newQuantity
      );
...
router.delete("/:cid", async (req, res) => {
  try {
    ...
    const emptyNewCart = await cartManagerService.deleteAllProductsInCart(
      cid,
      newCart
    );
