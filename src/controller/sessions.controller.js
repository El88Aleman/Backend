    ...
    try {
      ...
      if (email == "") {
        return res.render("forgotPassword", {
          error: "Tenés que ingresar tu email",
        });
      }
      ...
      res.render("forgotPassword", {
        message: "Se envío el link para restablecer tu contraseña a tu email",
      });
    } catch (error) {
      logger.error(
        `forgot password error: Error al obtener el restablecimiento de contraseña: ${error}`
      );
      res.json({
        status: "error",
        error: "Error al obtener el restablecimiento de contraseña",
      });
    }
  };
    ...
    try {
      ...
      if (!validEmail) {
        return res.render("resetPassword", {
          message: "El link para restablecer tu contraseña ha expirado",
        });
      }
      ...
      if (!user) {
        return res.render("resetPassword", {
          message: "Esta acción no es válida. El usuario no fue encontrado",
        });
      }
      ...
      logger.error(
        `reset password error: Error al cambiar la contraseña: ${error}`
      );
