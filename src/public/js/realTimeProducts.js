const cardProductsContainer = document.getElementById(
      ...
      if (product.thumbnail) {
        cardProduct += `
                    <img class="card-img-top" src="${
                      product.imageBuffer ||
                      "/assets/products/img/" + product.thumbnail
                    }" alt="${product.title}">
                `;
      }
...
const formAddProductContainer = document.querySelector(
  ".form-add-product-container"
);
const updateProductFormContainer = document.getElementById(
...
cardProductsContainer.addEventListener("click", (e) => {
  if (e.target.classList.contains("btn-update-product")) {
    ...
    document
      ...
      .querySelector("[name=title]").value = productInfo.title;
    document
      .getElementById("update-product-form")
      .querySelector("[name=description]").value = productInfo.description;
    document
      .getElementById("update-product-form")
      .querySelector("[name=code]").value = productInfo.code;
    document
      .getElementById("update-product-form")
      .querySelector("[name=price]").value = productInfo.price;
    document
      .getElementById("update-product-form")
      .querySelector("[name=stock]").value = productInfo.stock;
    document
      .getElementById("update-product-form")
      .querySelector("[name=category]").value = productInfo.category;
